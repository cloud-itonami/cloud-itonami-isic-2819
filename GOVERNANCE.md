...
`cloud-itonami-isic-2819` is an OSS open-business blueprint for
general-purpose-machinery plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an assembly/calibration-line-equipment action the governor refuses is never dispatched to hardware.
- the General-Purpose Machinery Plant Operations Governor remains independent of the advisor.
...
- bypassing assembly/calibration-line-equipment-control or record policy checks
