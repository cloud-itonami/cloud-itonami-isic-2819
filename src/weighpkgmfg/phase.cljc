(ns weighpkgmfg.phase
  "Phase 0->3 staged rollout for the general-purpose-machinery (ISIC
  2819) plant-operations coordination actor, illustrated with
  ...
  consequence (an assembly/calibration-test-bench-equipment
  ...
  `weighpkgmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a General-Purpose Machinery Plant Operations Governor verdict to
