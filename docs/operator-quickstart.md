# Operator Quickstart — Manufacture of other general-purpose machinery

Shortest path from clone to a verified local dry-run for **ISIC 2819** (`cloud-itonami-isic-2819`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2819.git
cd cloud-itonami-isic-2819
```
...
- Blueprint governor key: `general-purpose-machinery-plant-operations-governor`
- Likely source path: `weighpkgmfg.governor.cljc`
